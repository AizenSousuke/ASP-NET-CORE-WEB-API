...
namespace ASP_NET_CORE_WEB_API.Migrations
{
    ...
    [Migration("20200123130828_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_NET_CORE_WEB_API.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ASP_NET_CORE_WEB_API.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_NET_CORE_WEB_API.Entities.Course", b =>
                {
                    b.HasOne("ASP_NET_CORE_WEB_API.Entities.Author", "Author")
                        .WithMany("Courses")
